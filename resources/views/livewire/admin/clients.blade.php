<div class="flex flex-col gap-4 p-4 rounded-xl">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-2">
        ...
        {{-- 1. Temporary Upload Live Preview using Livewire state --}}
        @if ($thumbnail)
            <div wire:key="temporary-client-logo-preview" class="relative aspect-[16/10] border rounded-lg overflow-hidden shadow group p-2 bg-gray-50 dark:bg-zinc-900 flex items-center justify-center">
        ...
        @elseif ($isEditMode && $existingThumbnail)
            <div wire:key="existing-client-logo-preview" class="relative aspect-[16/10] border rounded-lg overflow-hidden shadow group p-2 bg-gray-50 dark:bg-zinc-900 flex items-center justify-center">
