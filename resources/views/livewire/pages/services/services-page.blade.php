       ...
       class="gradient-text inline-block hover:opacity-80 transition-opacity">
        {!! e($service['title']) !!}
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        <a href="{{ route('services.single', $service['slug']) }}" wire:navigate class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 text-white text-sm font-medium hover:bg-white/20 transition-colors">
                            View Details
                        </a>
